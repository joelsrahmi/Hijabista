          ...
          <table width="630" border="0">
            ...
            <tr>
              ...
              <td><select id="kritpost" name="kriteria" type="text">
                <?php
                if($row["kriteria"]=='News')
                {
                  ?>
                <option value="News" selected>News</option>
                <option value="Inspiring">Inspiring People</option>
                <option value="Tutorial">Tutorial</option>
                <?php
              }
               elseif($row["kriteria"]=='Inspiring People')
                {
                  ?>
                <option value="News">News</option>
                <option value="Inspiring" selected>Inspiring Peolpe</option>
                <option value="Tutorial">Tutorial</option>
                <?php
              }
                elseif($row["kriteria"]=='Tutorial')
                {
                  ?>
                <option value="News">News</option>
                <option value="Inspiring" selected>Inspiring Peolpe</option>
