...
$query_news = "select id_posting, date, judul, kriteria, artikel, gambar from posting where kriteria='Inspiration' order by id_posting desc";
    ...
    <div class="blog-masthead">
      <div class="container">
        <nav class="blog-nav">
          ...
          <a class="blog-nav-item active" href="#">Inspiring People</a>
