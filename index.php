...
<html lang="en">
  ...
  <body>
    <!--<div class="blog-masthead">
      <div class="container">
        <nav class="blog-nav">
          <a class="blog-nav-item masthead-brand active" href="#">Hijabista</a>
          <a class="blog-nav-item" href="news.php">News</a>
          <a class="blog-nav-item" href="inspiring.php">Inspiring Poeple</a>
      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="masthead clearfix">
            <div class="inner">
              <h3 class="masthead-brand active"><a href="#">Hijabista</a></h3>
              <ul class="nav masthead-nav">
                <li><a href="news.php">News</a></li>
                <li><a href="inspiring.php">Inspiring People</a></li>
          ...
          <div class="inner cover">
            <h1 class="cover-heading">Hijabista</h1>
            <p class="lead" style="font-family: 'Oleo Script', cursive; font-size: 30px">The news portal that enrich your knowledge about hijab.</p>
            <!--<p class="lead">
